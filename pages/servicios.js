...
function getDataInicio(){
    const dataInicio = fetch("https://cdn.contentful.com/spaces/2dvpig333b21/environments/master/entries/7uZQQzW3ds7LvgfmdAaU8x?access_token=tTyoacccYAP8EE1JGWF8ZKtoHSQHcHdqM9TSmqAHPSg")
    .then((r) => r.json())
    .then((d) => {return d})
